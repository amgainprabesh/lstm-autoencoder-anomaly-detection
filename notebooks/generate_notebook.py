"""
Script to generate notebooks/exploration.ipynb with full academic walkthrough.
"""
import json
...
def create_notebook():
    ...
    with open(out_dir / "exploration.ipynb", "w", encoding="utf-8") as f:
        json.dump(nb, f, indent=2)
    print("Saved notebooks/exploration.ipynb")
